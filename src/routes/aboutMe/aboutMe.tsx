...
const AboutMe = () => {
    ...
    const links: { label: string; link: string }[] = [
        {
            label: 'Tools I use 🛠',
            link: 'https://github.com/pbarrett21/tools-and-gadgets/blob/main/README.md',
        },
    ...
    return (
        ...
        >
            ...
            <p className='text-lg font-normal ml-8'>
                ...
                experience. I have been immersed in an agile development
                environment and have been fortunate to work with fantastic
                teammates on many interesting projects while using modern
                technologies. I have enjoyed being able to participate and
                contribute in the planning of new products and then to create
            ...
            <h1 className='font-semibold text-2xl mt-10 mb-6'>
                Hobbies and Interests
            </h1>
            <p className='text-lg font-normal ml-8'>
                I have many hobbies and interests outside of my professional
                life!
            </p>
