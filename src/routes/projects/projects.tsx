    ...
    return (
        <div className={theme === 'dark' ?
            ...
            <ProjectCard cardTitle={'LouTrails'}
                         ...
                         imgAlt={'LouTrails'}
                         blurb={'An informational website showcasing trails in the Louisville area.'}
                         technologies={['React', 'Styled Components', 'Mapbox GL JS', 'Gatsby']}
                         learnMorePath={'/loutrails'}
            />
            <ProjectCard cardTitle={'Portfolio Website'}
                         imgSrc={require('./../../resources/websitejpg.jpeg').default}
                         imgAlt={'Website'}
                         blurb={'Creating this website has been an enjoyable opportunity to try my hand at ' +
